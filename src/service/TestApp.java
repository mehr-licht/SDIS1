...
public class TestApp implements Runnable {
    ...
    /**
     * Subscrição do RMI, tal como feito na Lab do RMI
     *  lookup -> Como na lab:Returns the remote reference bound to the specified name in this registry.
     */
     ...
     * Usa filePathName + grau de replicação
     */
